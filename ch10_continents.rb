...
def continent_size world, x, y
  if world[y][x] != 'land' # Why are x and y reversed? Does the order matter?
...
# ?: I cut and pasted the code as is and got 21 as the output...
# ?: How are tiles being marked as visited?
